  ...
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div className="hidden w-full md:block md:w-auto text-sm" id="navbar-default ">
      <ul className="text-gray-600 flex justify-center items-center">
         <li>
          <Link className='mx-2 lg:mx-6' href='/home'>Home</Link>
        </li>
        <li>
          <Link className='mx-2 lg:mx-6' href='/shop'>Shop</Link>
        </li>
        <li>
          <Link className='mx-2 lg:mx-6' href="/about-us">About us</Link>
        </li>
        <li>
    ...
    <div className='hidden md:flex justify-center items-center  text-white text-sm lg:mr-14 '>
        ...
        <button className='border-1 border-white mx-1 py-1.5 px-2 lg:px-4 rounded-sm'>Sign in</button>
    </div>
  </div>
  {/* mobile menu  */}
   <div className={`md:hidden ${open?'block':'hidden'} bg-amber-50 w-40  ml-auto py-2 absolute right-0 z-0`}>
